...
$("#monthScreen").fadeOut(400, function () {

    $("#flowerResult").fadeIn(400);
...
/* =================================
BACK TO BIRTH MONTHS
================================= */

function backToBirthMonths(event) {

event.preventDefault();

$("#flowerResult").fadeOut(400, function () {

    $("#monthScreen").fadeIn(400);
...
let flowerImage = $("#flowerImage").attr("src");
